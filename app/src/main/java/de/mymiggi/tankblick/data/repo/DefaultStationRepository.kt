...
class DefaultStationRepository(
    ...
    override fun observeNearby(): Flow<List<Station>> =
    ...
    override suspend fun refreshNearby(
        ...
        val result = api.findNearby(apiKey, latitude, longitude, radiusKm)
    ...
    override suspend fun refreshFavorites(apiKey: ApiKey): ApiResult<Int> {
    ...
    override suspend fun refreshStationDetail(apiKey: ApiKey, stationId: String): ApiResult<StationDetailDto> {
     ...
     * possible.
     */
    override suspend fun purgeOldSnapshots(retentionDays: Int): Int =
